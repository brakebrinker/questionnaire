...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/input/input--button--split.html.twig", "/home/ITRANSITION.CORP/m.pevnev/projects/www/questionnaire/themes/bootstrap/templates/input/input--button--split.html.twig");
    }
}
